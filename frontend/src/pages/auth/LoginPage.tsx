...
const botaoSocialBase: React.CSSProperties = {
  flex: 1,
  height: '44px',
  borderRadius: '12px',
  border: '1px solid rgba(180,158,210,0.60)',
  display: 'flex',
  alignItems: 'center',
  ...
  fontWeight: 500,
  fontFamily: FONT,
  color: 'rgba(40,15,80,0.75)',
  cursor: 'not-allowed',
  opacity: 0.75,
  boxShadow: '0 2px 8px rgba(80,40,140,0.14)',
}
    ...
    >
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <button type="button" disabled style={{ ...botaoSocialBase, background: 'rgba(255,255,255,0.70)' }}>
          ...
          <button type="button" disabled style={{ ...botaoSocialBase, background: 'rgba(220,210,235,0.60)' }}>
